...
<html>
<head>
	<title>Rigs of Rods Multiplayer Server Management Panel - $title</title>
...
<body onLoad="javascript: urlprefix='$url[prefix]'; servername='$server'; updateServerStatus('$serverstatus'); $onload "><table class="maintable" style="border-spacing: 0;">
	<div class="manage"/>
		<!--header-->
		<tr>
<th colspan="$colnum" style="width: 400px; text-align: center; border-bottom: 3px double #FFFF00;"><font color="#FFFF00">Rigs of Rods Multiplayer Server Management</th></font>
		</tr>
		</div>
		<!--<tr>
...
if(!empty($content))
{
	echo <<<EOF
		<tr>
			<td id="contentBox" class="tdmain" colspan="$colnum" style="padding-top: 0;  height: auto; width: 400px;">$content</td>
		</tr>
EOF;
}
